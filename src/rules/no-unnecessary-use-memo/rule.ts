...
const messages = {
	[MESSAGE_ID_DEFAULT]:
		"An 'useMemo' with empty deps and no references to the component scope may be unnecessary.",
...
export const noUnnecessaryUseMemo = createFlawlessRule<Options, MessageIds>({
	name: RULE_NAME,
	createOnce,
	defaultOptions: [],
	meta: {
